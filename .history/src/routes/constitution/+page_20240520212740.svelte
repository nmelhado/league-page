...
<div class="constitution">
    ...
    <p>Trading of players is allowed. Trades will process immediately and will be reversed if vetoed or under investigation for collusion. Tradable assets include players, and good will.</p>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li> A league meeting of all members not involved in any of the improper trades/activity in question will take place to discuss next steps.</li>
        </ul>
    ...
    <p>Inverse Order of week's standings Waiver wire system. Each week, the inverse order of the standings will be how the waiver order will be set.</p>    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be randomized by the platform an hour before the draft.</p>
    
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical Full PPR Scoring). The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 8 teams will make the playoffs. The first round of playoffs will commence in week 15. Each team that wins their division, will receive a playoff berth and the top 2 seeds. The rest of the 6 teams with the best record will duke it out for the next 6 seeds. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
