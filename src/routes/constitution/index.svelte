...
<div class="constitution">
    ...
    <p>Trading of players is allowed. Trades will process immediately and will be reversed if vetoed or under investigation for collusion.</p>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Immediate reduction of potential winnings by 80%</li>
    ...
    <ul>
        <li>1st place: {dues * 4.66 + 1}$</li>
        <li>2nd place: {dues * 2}$</li>
        <li>3rd place: {dues}$</li>
        <li>Overall high score for <em>regular</em> season:</li>
        <li>{dues}</li>
        <li>Weekly high score, last 4 <em>regular</em> season games:</li>
        <li>{dues / 3}/each</li>
    </ul>
