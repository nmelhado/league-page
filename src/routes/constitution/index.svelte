...
<div class="constitution">
    <h1 class="noUnderscore">SIX PACK DYNASTY CONSTITUTION</h1>
...
//    </div>
    ...
    <div class="subBlock">
        <p>The trade deadline will is NFL week 14.</p>
    </div>
    ...
    <div class="subBlock">
        <p>Trades should only be vetoed if expected collusion. Not everyone knows your team plans. 5 vetoes are needed to veto a trade.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Tuesday nights</p>

    <p>FAAB $ not spent in season will roll to next season. FAAB budgets will reset to $50 in offseason (after league championship.</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a somewhat of a linear draft in reverse order of the previous year’s regular season standings.</p>
	...
	Pick 8- 3rd Place Playoff Bracket Results
	Pick 9- 2nd Place Playoff Bracket Results
	Pick 10-1st Place Playoff Bracket Results</p>
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The 2 teams that have the best regular season record (or most points scored in case of a tie) will receive a BYE. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>League dues are set at 50$. Dues are collected through various ways and dues must be paid by rookie draft. All managers must be fully paid up before the start of regular season.</p>
