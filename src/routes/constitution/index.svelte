...
<div class="constitution">
    ...
    <div class="subBlock">
        <p>Any player traded from a team may be re-acquired via trade within 6 weeks of the original trade..</p>
    </div>
