...
<div class="constitution">
    <h1 class="noUnderscore">RCL CONSTITUTION</h1>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(five)}>Section 5: Special Events</h3>
    
        <h4 class="noUnderscore clickable" on:click={() => goToSection(fiveOne)}>5.1 League Tanking Policy</h4>
        <h4 class="noUnderscore clickable" on:click={() => goToSection(fiveTwo)}>5.1 Last Place</h4>
        <h4 class="noUnderscore clickable" on:click={() => goToSection(fiveThree)}>5.1 League Recaps</h4>
    ...
    <p>1 IR Spots (Player must be labeled as IR, Suspended, or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">No Max</td></tr>
                <tr><td>RB</td><td class="right">No Max</td></tr>
    ...
    <p>Trading of players and draft picks is allowed. Trades will process immediately and will be reversed if vetoed or under investigation for collusion. Tradable assets include players, draft picks, and favors of a sexual nature.</p>
    
    <h4 bind:this={oneTwoOne}>1.2.1 Trade Collusion</h4>
    <div class="subBlock">
        <p>If any owners are suspected of accepting bribes/offering bribes to enhance their/another owners team via trade, trading any assets other than fantasy players or draft picks, or otherwise found guilty of engaging in any form of collusion*, all parties involved in the trade will be SEVERELY PUNISHED. The punishments will go as followed:</p>
        
        <ul>
            <li>First Offense – Forfeiture of draft picks.</li>
            <li>Second Offense – Idk, something serious tho.</li>
        ...
        <p>All trades that are found guilty of collusion, will be reversed/denied. If the trade had affected the outcome of previous games, the results of those games will be reviewed and possible revised.  </p>
    ...
    <div class="subBlock">
        <p>Any player traded from a team may not be re-acquired via trade within 6 weeks of the original trade. Any teams involved in this behavior will be subject to the aforementioned collusion punishments. This is in keeping with the standard, "No tradsies-backsies" policy that we all try to live by.</p>
    </div>
    ...
    <p>Waiver wire priority will be the inverse of the standings.</p>

    <p>Bids will process on Wednesday morning.</p>
    ...
    <ol>
        ...
        <li>Coin Flip</li>
        <li>Race around the World</li>
    </ol>

    <h2 class="sectionHeading" bind:this={five}>Section 5: Special Events </h2>
    ...
    <p>In the event that a league member misses the recap deadline, they will be subject to a punishment determined by a majority vote of the league.</p>
    ...
    <p>League dues are set at {dues}$. Dues should be sent directly to the commissioner via cash, check or Venmo. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, they may be subject to punishment and/or public shaming.</p>
