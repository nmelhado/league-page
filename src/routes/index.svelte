...
<div id="home">
	...
	<div id="odds">
	    <iframe id="frame" style="width: 100%;border:0px solid black;height: 100%;" src="https://www.theffhub.com/Home/PlayoffOdds?site=Sleeper&leagueId=716328508556668928&userId=&s2=&swid=" frameborder="0"></iframe>
	</div>
        <PowerRankings />
    </div>
