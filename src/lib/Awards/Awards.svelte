...
<div>
	<h3>Pre-Sleeper Awards</h3>
		...
		<div id="podium">
			...
			<!-- champs -->
			<img src="{getAvatarFromTeamManagers(leagueTeamManagers, 3, 2023)}" class="first champ clickable" on:click={() => gotoManager({2023, leagueTeamManagers, rosterID: 3})} alt="champion" />
			
			<span class="label firstLabel clickable" on:click={() => gotoManager({2023, leagueTeamManagers, rosterID: 3})}>{@html getNestedTeamNamesFromTeamManagers(leagueTeamManagers, 2023, 3)}</span>
		</div>
		...
		<div class="toiletParent">
				...
				<div class="toiletBowl">
					<img src="{getAvatarFromTeamManagers(leagueTeamManagers, 8, 2023)}" class="toiletWinner clickable" on:click={() => gotoManager({2023, leagueTeamManagers, rosterID: 8})} alt="toilet bowl winner" />
					<img src="./toilet-bowl-2.png" class="toilet" alt="toilet bowl" />
				</div>
				<span class="genLabel clickable" on:click={() => gotoManager({2023, leagueTeamManagers, rosterID: 8})}>{@html getNestedTeamNamesFromTeamManagers(leagueTeamManagers, 2023, 8)}</span>
		</div>
	</div>
