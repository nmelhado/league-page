<script>
	...
	import { getAvatarFromTeamManagers, getNestedTeamNamesFromTeamManagers, getAllManagerNames } from '$lib/utils/helperFunctions/universalFunctions';
...
<div class="awards">
	<h3>{year} Awards</h3>
	<h2>{getAllManagerNames(leagueTeamManagers, 2023)}</h2>
