...
export const managers = [
  // TUCKER 
  {
       ...
       "rival": {
         ...
         image: "/managers/Cooper.PNG", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
    ...
    // Cooper
  {
       ...
       "photo": "/managers/Junzhe.JPG", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2015, // (optional) when did the manager start playing fantasy football
    ...
    // SAM
  {
       ...
       "bio": "Lorem ipsum...",
       "photo": "/managers/SamCowboy.PNG", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2015, // (optional) when did the manager start playing fantasy football
    ...
    // Puleo
  {
       ...
       "rival": {
         ...
         image: "/managers/SamCowboy", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
