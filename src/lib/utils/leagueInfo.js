...
export const managers = [
    {
      ...
      "bio": "Der beste Fantasy Football Manager der Welt. Außerdem, der beste Mensch - und Commisioner - der Welt.",
    ...
    },
    {
      ...
      "favoritePlayer": 13982, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
    ...
    },
    {
      ...
      "bio": "Zu busy, um weiter zu machen.",
      "photo": "/managers/everyone.png", // square ratio recommended (no larger than 500x500)
