...
export const homepageText = `
  ...
  <p><img src="../../worldmapofmanagers.png" alt="worldmap"</p> 
  <p></p>
  <p>Our history will be made in the coming years. But if history has taught us one thing, it's this:</p>
  <h4><p>LACES OUT DAN!</p></h4>
  <p></p>
  <p><img src="../../shulacesoutdan-rayfinkleteamphoto.jpg" alt"Ray Finkle Team Photo" width="400px" height="295px"></p>
`;
