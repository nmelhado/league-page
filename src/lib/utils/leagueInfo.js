...
export const homepageText = `
  <p style="font-size: 12px;">Welcome to MFFLs website, where competition and camaraderie go hand in hand!</p>
  <img src="league-page/static/managers/2023.jpg" alt="MFFL League Image" style="display: block; margin: 20px auto; width: 100%; max-width: 600px;">
