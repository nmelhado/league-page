...
export const managers = [
    {
      "roster": 1,  // (DEPRICATED) ID of the roster that the manager manages (look at the order of the power rankings graph)
      "managerID": 869660544473432064,
      "name": "John Galiano",
      "tookOver": 2020, // (DEPRICATED) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Hoboken", // (optional)
      "bio": "Nucking futs bro",
