<script>
    ...
    export let key, leagueManagerRecords, leagueWeekHighs, leagueWeekLows, allTimeBiggestBlowouts, allTimeClosestMatchups, currentTeams, mostSeasonLongPoints, leastSeasonLongPoints, transactionTotals;
